...
public class SubsetSumHashGadget extends Gadget {
	...
	public static final int DIMENSION = 1; // set to 4 for higher security
	public static final int INPUT_LENGTH = 3 * DIMENSION * Config.LOG2_FIELD_PRIME; // maximum = 3 blocks
	...
	public SubsetSumHashGadget(Wire[] ins, boolean binaryOutput, String... desc) {
		...
		if (numBlocks > 1) {
			throw new IllegalArgumentException("Input length is too long!");
		}
